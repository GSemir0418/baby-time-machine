...
export const PreviewPage: React.FC = () => {
  ...
  return (
    <div className="h-full p-2 bg-zinc-900 text-white overflow-y-auto pb-[80px]">
      ...
      <div className="mt-4 mb-4 text-lg">
        ...
        <div className="overflow-hidden w-full border-b-2 border-zinc-600 mb-2 pb-2">
          <div>拍摄时间</div>
          <span className="text-zinc-400 text-sm">{dateTimeDigitized ?? '暂无'}</span>
        </div>
        <div className="overflow-hidden w-full border-b-2 border-zinc-600 mb-2 pb-2">
          <div>拍摄设备</div>
          <p className="text-wrap break-all text-zinc-400 text-sm">{device ?? '暂无'}</p>
        </div>
      </div>
